...
def main():
        ...
        submit_download.write("Universe   = container\n")
        submit_download.write("container_image = /home/thomas.jacquot/my-container-v0.sif \n")
        submit_download.write("transfer_container = True\n")
        submit_download.write("Arguments  = --start-time " + str(start_time) + " --end-time " + str(end_time) +  " --format datetime --output " + output_path + "\n")
        submit_download.write("input      = /dev/null\n")
        submit_download.write("Log        =" +  error_submit_download  + "/download_condor_poshist.log\n")
        submit_download.write("error      =" + error_submit_download + "/download_condor_poshist.err\n")
        ...
        submit_download.write("request_memory = 4096\n")
        submit_download.write("request_disk = 100 Gb\n")
        ...
        submit_download.write("error      =" + error_submit_download + "/download_condor_tte.err\n")
        submit_download.write("output     = /dev/null\n")
        submit_download.write("notification = never\n")
        #submit_download.write("getEnv     = True\n")
        submit_download.write("accounting_group = ligo.prod.o4.cbc.grb.gbm_subthreshold\n")
        ...
        submit_targeted.write("Universe   = container\n")
        submit_targeted.write("container_image = /home/thomas.jacquot/my-container-v0.sif \n")
        submit_targeted.write("transfer_container = True\n")
        ...
        submit_targeted.write("request_memory = 4096 Mb\n")
        submit_targeted.write("request_disk = 4096 Mb\n")
        ...
        submit_merge.write("Universe   = container\n")
        submit_merge.write("container_image = /home/thomas.jacquot/my-container-v0.sif \n")
        submit_merge.write("transfer_container = True\n")
        ...
        submit_merge.write("request_memory = 65536 Mb\n")
        submit_merge.write("request_disk = 4096 Mb\n")
        ...
        submit_transfer.write("Universe   = container\n")
        submit_transfer.write("container_image = /home/thomas.jacquot/my-container-v0.sif \n")
        submit_transfer.write("transfer_container = True\n")
        ...
        submit_transfer.write("request_memory = 65536 Mb\n")
        submit_transfer.write("request_disk = 4096 Mb\n")
        ...
        submit_dag_file.write("JOB B submit_tte.sub\n")
        submit_dag_file.write("CATEGORY A download\n")
        submit_dag_file.write("CATEGORY B download\n")
        ...
        for i in range(len(fermi_time_array)):
                submit_dag_file.write("PARENT A B")	
        ...
        submit_dag_file.write("MAXJOBS download 1\n")
